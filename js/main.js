...
const producto1 = new Producto(1, "Pizza Italiana", "Pizzas","../img/logoKaru.png","../img/logoKaru.png", 5000, 10);
const producto2 = new Producto(2, "Pizza Pepperoni", "Pizzas","../img/logoKaru.png","../img/logoKaru.png", 6000, 10);
const producto3 = new Producto(3, "Pizza vegetariana", "Pizzas","../img/logoKaru.png","../img/logoKaru.png", 5500, 10);
const producto4 = new Producto(4, "Sandwich Chacarero", "Sandwich","../img/logoKaru.png","../img/logoKaru.png", 5500, 5);
const producto5 = new Producto(5, "Sandwich Luco", "Sandwich","../img/logoKaru.png","../img/logoKaru.png", 5000, 5);
const producto6 = new Producto(6, "Sandwich Italiano", "Sandwich","../img/logoKaru.png","../img/logoKaru.png", 5500, 5);
...
function armarCarrito (lista){
    ...
    lista.forEach(producto => {
        ...
        <div class="card-body">
            ...
            <p class="card-text">esto es una descripcion momentanea sujeta a cambios.</p>
